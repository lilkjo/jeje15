module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'C R 7 💙'
      ...
      if (!('owners' in setting)) setting.owners = ['34612538080', '34612538080']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'السلام عليكم +tag 💙'
      if (!isNumber(setting.menuStyle)) setting.menuStyle = 2
      if (!('cover' in setting)) setting.cover = 'https://i.ibb.co/9Zr1yfy/Getty-Images-1155031247.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/GfIKRSyVARcH8rejkufWqC'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['34612538080', '34612538080'],
         lastReset: new Date * 1,
         msg: 'السلام عليكم +tag 💙',
         menuStyle: 2,
         cover: 'https://i.ibb.co/9Zr1yfy/Getty-Images-1155031247.jpg',
         link: 'https://chat.whatsapp.com/GfIKRSyVARcH8rejkufWqC'
      }
   }
}
